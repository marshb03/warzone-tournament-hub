"""Refining match model so match number resets32

Revision ID: 900598534454
Revises: eecbaac6df6a
Create Date: 2024-10-23 09:22:06.118483
...
revision: str = '900598534454'
down_revision: Union[str, None] = 'eecbaac6df6a'
...
def upgrade() -> None:
    ...
    op.create_unique_constraint('unique_match_number_per_round', 'matches', ['tournament_id', 'round', 'match_number'])
...
def downgrade() -> None:
    ...
    op.drop_constraint('unique_match_number_per_round', 'matches', type_='unique')
