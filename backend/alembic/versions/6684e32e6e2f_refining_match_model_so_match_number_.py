"""Refining match model so match number resets

Revision ID: 6684e32e6e2f
Revises: 49e074787ec5
Create Date: 2024-10-23 09:15:19.156714
...
revision: str = '6684e32e6e2f'
down_revision: Union[str, None] = '49e074787ec5'
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_index('ix_matches_match_number', 'matches', ['match_number'], unique=False)
