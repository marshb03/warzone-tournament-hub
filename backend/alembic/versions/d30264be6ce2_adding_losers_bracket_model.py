...
Revision ID: d30264be6ce2
Revises: c1d84806da55
Create Date: 2024-10-28 11:12:44.789308
...
revision: str = 'd30264be6ce2'
down_revision: Union[str, None] = 'c1d84806da55'
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('matches', sa.Column('loser_id', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('matches', sa.Column('is_losers_bracket', sa.BOOLEAN(), autoincrement=False, nullable=True))
    op.create_foreign_key('matches_loser_id_fkey', 'matches', 'teams', ['loser_id'], ['id'])
