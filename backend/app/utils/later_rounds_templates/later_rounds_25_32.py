# app/utils/later_rounds_templates/later_rounds_25_32.py

from typing import Dict, List, Optional, Union

LATER_ROUNDS = {
    # This template covers rounds 3+ for all tournaments with 25-32 teams
    "rounds": {
        3: [
            {
                "match_id": "L-R3M101",
        ...
        8: [
            {
                "match_id": "L-R8M101",
                "team1": {
                    "from": "W-R5M1",  # Loser from winners bracket semifinals
                    "round": 5,
                    "match": 1,
                    "from_winners": True
                },
